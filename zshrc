...
DIRS=(${HOME}/node_modules/.bin /usr/games/bin /usr/local/games/bin /usr/games /usr/local/games /usr/local/bin /opt/wine-staging/bin /opt/wine-devel/bin ${HOME}/.cargo/bin /opt/homebrew/bin ${HOME}/osxcross/target/bin ${HOME}/.local/bin ${HOME}/bin /Library/TeX/texbin ${HOME}/android_sdk/cmdline-tools/bin /opt/rv32i/bin)
